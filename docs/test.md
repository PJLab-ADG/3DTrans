...
- **once_(small/medium/large)_pseudo.pkl**, which use pseudo label generator as mentioned in our [paper](https://arxiv.org/pdf/2306.00612.pdf) to generate pseudo labels. You can download [here]().

- After the data preparation process, you can pre-train by the following command:
  ```shell script
...
- **AD-PT pre-trained checkpoints and pseudo data**
  <span id="once-ckpt">
